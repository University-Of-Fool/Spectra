    ...
    return (<>
        ...
        <div className={"flex justify-center"}>
            <div className={"mx-10 mb-10 w-280"}>
                {extraData.title && (<div className={"flex items-baseline mb-2 mx-1 font-mono"}>
                    <div className={"text-lg opacity-100"}>{extraData.title}</div>
                    <div className={"text-sm opacity-75 ml-auto"}>{extraData.language}</div>
                </div>)}
                <div>
                    <CodeBlock
